...
export default {
  ...
  data () {
    return {
      ...
      dialogCode: '',
      skuCode: '',
      urlPrefix: 'https://staging-cn-loreal.demandware.net/on/demandware.static/-/Sites-shubeauty-cn-Library/default',
    ...
    modifyEle () {
      ...
      this.$nextTick(() => {
        $('img').each(function (index) {
          ...
          _this.css('width', '100%')
          let src = _this.attr('data-src') || _this.attr('src') || _this.attr('pcsrc') || _this.attr('pc-src') || _this.attr('data-pcsrc') || _this.attr('mb-src')
          // 补全路径
          ...
          if (parent.hasClass('mobile-block') && !parent.hasClass('LPmob') && !parent.hasClass('landingpage-mob')) {
